...
import { Breadcrumb, BreadcrumbItem, Button, Form, FormGroup, Label, Input, Col, Row, FormFeedback, Fade} from 'reactstrap';
...
class Contact extends Component {
    ...
    constructor (props) {
        ...
        this.state ={ // give same names as these properties in the forms input as well 
            firstname: "",
            lastname: '',
            telnum: "",
            email: "",
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        errors.telnum ="Tel. Number should contain onlu numbers";
